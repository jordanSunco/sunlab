package org.openscales.core.layer
{
	...
	public class Grid extends HTTPRequest
	{
        ...
        private var _tileOriginCorner:String = "bl";
		...
		public function initGriddedTiles(bounds:Bounds, clearTiles:Boolean=true):void {
            ...
            // 根据OpenLayers.Layer.Grid做出修改, 满足通过maxExtent或者tileOrigin来计算瓦片位置
            var origin:Location = getTileOrigin();
            var resolution:Number = map.resolution;
            var tileLayout:Object = calculateGridLayout(bounds, origin, resolution);
            ...
            var tileoffsetx:Number = tileLayout.tileoffsetx;
            var tileoffsety:Number = tileLayout.tileoffsety;
         ...
         * If a <code>tileOrigin</code> property is supplied, that will be returned.
         * Otherwise, the origin will be derived from the layer's 
         * <code>maxExtent</code> property. In this case,
         * the tile origin will be the corner of the <code>maxExtent</code> given by the
         * <code>tileOriginCorner</code> property.
         * 
         * @return The tile origin.
         * @see OpenLayers.Layer.Grid.getTileOrigin
         */
        public function getTileOrigin():Location {
            var origin:Location = this.tileOrigin;
            if (!origin) {
                ...
                origin = new Location(extent[edges[0]], extent[edges[1]]);
            }
            return origin;
        }
         ...
         * @param resolution
         * 
         * @return Object containing properties tilelon, tilelat, tileoffsetlat,
         *     tileoffsetlat, tileoffsetx, tileoffsety
         * @see OpenLayers.Layer.Grid.calculateGridLayout
         */
        public function calculateGridLayout(bounds:Bounds, origin:Location,
                resolution:Number):Object {
            var tilelon:Number = resolution * this.tileWidth;
            var tilelat:Number = resolution * this.tileHeight;

            var offsetlon:Number = bounds.left - origin.lon;
            ...
            var tileoffsetlon:Number = origin.lon + tilecol * tilelon;

            var offsetlat:Number = bounds.top - (origin.lat + tilelat);
            ...
            var tileoffsetlat:Number = origin.lat + tilerow * tilelat;
         ...
         * <code>maxExtent</code>.
         * 
         * @see OpenLayers.Layer.Grid.tileOrigin
         */
        ...
        /**
         * If the <code>tileOrigin</code> property is not provided, the tile origin
         * will be derived from the layer's <code>maxExtent</code>.
         * The corner of the <code>maxExtent</code> used is determined by this property.
         * Acceptable values are "tl" (top left), "tr" (top right), "bl" (bottom left),
         * and "br" (bottom right). Default is "bl".
         * 
         * @see OpenLayers.Layer.Grid.tileOriginCorner
         */
        public function get tileOriginCorner():String {
            return _tileOriginCorner;
        }

        public function set tileOriginCorner(value:String):void {
            _tileOriginCorner = value;
        }
	}
}
