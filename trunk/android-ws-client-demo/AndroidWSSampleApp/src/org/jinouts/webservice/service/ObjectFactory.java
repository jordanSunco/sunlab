 ...
 * generated in the org.jinouts.webservice.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Login_QNAME = new QName("http://service.webservice.jinouts.org/", "login");
    private final static QName _LoginResponse_QNAME = new QName("http://service.webservice.jinouts.org/", "loginResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.jinouts.webservice.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.jinouts.org/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.jinouts.org/", name = "loginResponse")
