 ...
 * 
 * 扩展send()中的body.setFileName(file.getName()), 对其进行编码以便支持中文附件名
 * 本来是要扩展MimeMailer的, 但是其中很多属性都是私有的, 没有办法直接Copy & Paste.
 * 
 * by Sun 2010.06.30
 * 
 * @since Ant 1.5
    ...
    public void send() {
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                body.setFileName(MimeUtility.encodeWord(file.getName()));
