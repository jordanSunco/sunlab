package com.monkey.supermap {
    ...
    public class SuperMapGeometryDialectTest {
        ...
        public function testToPointJson():void {
            ...
            var geometryJson:String = geometryDialect.toGeometryJson(geometry);

            var point:Point = geometryDialect.getGeometry(geometryJson) as Point;
        ...
        public function testToLineJson():void {
            ...
            var geometryJson:String = geometryDialect.toGeometryJson(
                new LineString(vertices));

            var lineString:LineString = geometryDialect.getGeometry(geometryJson) as LineString;
        ...
        public function testToRegionJson():void {
            ...
            var polygon:Polygon = geometryDialect.getGeometry(geometryJson) as Polygon;
            assertEquals(vertices.toString(),
                points2Coordinates(polygon.toVertices()));
        }
